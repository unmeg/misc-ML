...
savename = options.wav1 +'_' + options.wav2 + '_spec.png'
...
def spectrum_comparison(audio_one, audio_one_sr, audio_two, audio_two_sr, save_filename=None):
